            ...
            <div class="container mx-auto">
                <div class="flex h-16 justify-between items-center">
                    ...
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('logout') }}" class="ml-8 inline-flex items-center justify-center rounded border border-transparent bg-black px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-500">Sign up</a>
                        @endif
                    </div>
                </div>
            </div>
